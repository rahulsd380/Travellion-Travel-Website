  ...
  return (
    <div className="">
      <div className="relative w-full">
          ...
          <div className="px-10">
          <h1 className="text-6xl text-white mb-5">Start your unforgettable <br /> journey with us.</h1>
      <p className="pb-10 text-gray-300">The best travel for your jouney begins now</p>
          </div>

      <div className="flex">
      <div className="bg-white p-10 flex gap-5">
      <div className="">
      ...
      <div className="bg-[#ff7757] p-5 flex items-center gap-4 rounded-r-xl">
        <h1 className="text-2xl text-white">Book <br /> Now</h1>
